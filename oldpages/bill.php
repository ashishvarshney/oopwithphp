...
for($i = 0 ;$i<$countArray;$i++) { ?>
        ...
        <td><input type="hidden" name="product_details_id[]" value="<?php echo $product_details_id[$i];?>"><input type="hidden" name="product_name[]" value="<?php echo $product_name[$i];?>"><?php echo $product_name[$i];?></td>
					<td> <input type="hidden" name="chk_category_book[]" value="<?php echo $chk_category_book[$i];?>"> <?php echo $chk_category_book[$i];?></td>
				<td>  <input type="hidden" name="chk_category_app[]" value="<?php echo $chk_category_app[$i];?>"><?php echo $chk_category_app[$i];?></td>
				<td>$<input type="hidden" name="product_price[]" value="<?php echo $product_price[$i];?>"><?php echo $product_price[$i];?></td>
        <td>$<input type="hidden" name="product_totalamount[]" value="<?php echo $product_price[$i];?>"><span class="getAllTotal"><?php echo $product_price[$i];?></span></td>
...
<div class="row">
     <div class="col-sm-12">
     <input type="hidden"  name="cartamount" value="<?php echo $item_price; ?>">
  ...
  <div class="col-sm-12">
	    ...
	    <h1> <input type="radio"  name="paymentmode" value="<?php echo $payment_choose;?>" <?php echo $checked;?>>Paid In Full </h1>
      ...
      <span><b>Advertising Total</b> : </span><span class="pull-right">$<?php echo $item_price; ?></span><br>
          ...
          <span>Paid in Full Discount<span class=""></span> <span class="pull-right"><?php echo $item_price * 2; ?> </span><br>
	        <span><b>Total</b> :</span> <span class="pull-right"><input type="hidden" name="payamount" value="<?php echo $item_price * 10; ?>">$<?php echo $item_price * 10; ?></span>
	    </div>
  ...
  <?php } elseif($payment_choose == "third"){ 
    ...
    ?>
	    	...
	    	<div class="col-sm-12 ">
        <h1> <input type="radio"  name="paymentmode" value="<?php echo $payment_choose;?>" <?php echo $checked;?>>  Third / Third / Third </h1>
	     <div>
       <span><b>Advertising Total</b> : <span class="pull-right">$<?php echo $item_price; ?></span><br>
          ...
          <span><b>Total</b> : <span class="pull-right"><input type="hidden" name="payamount" value="<?php echo $item_price * 12; ?>">$<?php echo $item_price * 12; ?></span><br>
      ...
      <?php } elseif($payment_choose == "monthly"){
        ...
        ?>
	    	<div class="col-sm-12">
        <h1> <input type="radio"  name="paymentmode" value="<?php echo $payment_choose;?>" <?php echo $checked;?>> Monthly Billing </h1>
	     <div>
       <span><b>Advertising Total</b> : </span><span class="pull-right">$<?php echo $item_price; ?></span><br>
          ...
          <span><b>Total</b> : </span><span class="pull-right"><input type="hidden" name="payamount" value="<?php echo ($item_price + $setVariableTable[0]['handling_charge']) * 12; ?>">$<?php echo ($item_price + $setVariableTable[0]['handling_charge']) * 12; ?></span><br>
      ...
      <?php } elseif($payment_choose == "nomoney"){ 
        $checked = 'checked';?>
	    	<div class="col-sm-12">
        <h1><input type="radio"  name="paymentmode" value="<?php echo $payment_choose;?>" <?php echo $checked;?>> No Money Down Bill on Publication
        </h1>
	     <div>
       <span><b>Advertising Total</b> : </span><span class="pull-right">$<?php echo $item_price; ?></span><br>
          ...
          <span><b>Total</b> :</span><span class="pull-right"><input type="hidden" name="payamount" value="<?php echo ($item_price + $setVariableTable[0]['no_money_handling_charge']) * 12; ?>">$<?php echo ($item_price + $setVariableTable[0]['no_money_handling_charge']) * 12; ?></span><br>
      ...
      <?php }  ?>
	    ...
	    <center>
      <input type="submit" value="Save & Pay" class="btn btn-success">
